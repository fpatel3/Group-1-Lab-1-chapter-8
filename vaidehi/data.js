...
dataArray[0] = { 'price': prices[0], 'quantities':quantities[0] };
dataArray[1] = { 'price': prices[1], 'quantities':quantities[1] };
dataArray[2] = { 'price': prices[2], 'quantities': quantities[2] };
